          ...
          {conversations.map((c) => (
            ...
            >
              ...
              <button
                ...
                className="mr-1 flex-shrink-0 rounded p-2 text-slate-300 hover:bg-slate-100 hover:text-red-600 sm:opacity-0 sm:group-hover:opacity-100"
                aria-label="刪除對話"
              >
    ...
    <>
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-40 md:hidden">
          ...
          <aside className="absolute inset-y-0 left-0 flex w-72 max-w-[80vw] flex-col gap-2 overflow-y-auto bg-white p-2 shadow-xl">
            <div className="flex items-center justify-between px-1 pb-1">
              <span className="text-sm font-semibold text-slate-900">對話紀錄</span>
              <button
